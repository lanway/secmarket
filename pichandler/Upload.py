...
class AuthKeyHandler:
    def __init__(self):
        self.access_key = '34nWVwqt1B5OdkWTE0yqK_IR4GK0rPok-m5jCJtV'
        self.secret_key = 'd9i8-rgBpUNYV8rGW57lk5hrqbt4p_4qzo6xeulW'
        self.Auth_key = Auth(self.access_key, self.secret_key)
        self.auth_tokens = []
    # 构建鉴权对象
    def generateToken(self,names):
       bucket_name = 'secmarket' # 要上传的空间
       tokens = []
       for title in names:
           print 'title:',title
    ...
    def download_url(self,name):
        ...
        bucket_domain = 'on3o4mkcz.bkt.clouddn.com'
